...
class Categories_model extends Model
{
    ...
    protected $casts = [
        ...
        'priority' => 'integer',
        'status' => 'boolean',
        'frontend_visible' => 'boolean', // FIXED: Add frontend_visible cast
        'nest_left' => 'integer',
        'nest_right' => 'integer',
    ];
    ...
    // FIXED: Add scope for frontend visible categories
    public function scopeFrontendVisible($query)
    {
        return $query->where(function($q) {
            $q->where('frontend_visible', 1)
              ->orWhereNull('frontend_visible'); // Backward compatibility
        });
    }
