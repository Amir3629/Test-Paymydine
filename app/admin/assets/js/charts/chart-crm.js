...
document.addEventListener("DOMContentLoaded", function () {
  ...
  console.log("Today:", tenantStats.today);
  console.log("This Week:", tenantStats.week);
  console.log("This Month:", tenantStats.month);
  console.log("This Year:", tenantStats.year);



  // Now, your chart will use the dynamic PHP data
});
!function (NioApp, $) {
  "use strict";
  ...
  var OrganicSearchData = {
    ...
    datasets: [{
      ...
      data: [tenantStats.today, tenantStats.week, tenantStats.month, tenantStats.year]
    }]
  };
  var SocialMediaData = {
    labels: ["01 Jan", "02 Jan", "03 Jan", "04 Jan", "05 Jan", "06 Jan", "07 Jan", "08 Jan", "09 Jan", "10 Jan", "11 Jan", "12 Jan"],
