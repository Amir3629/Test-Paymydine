...
App::before(function () {
    /*
     * Payment Icons Static Proxy - must be before admin catch-alls
     */
    Route::get('/images/payments/{filename}', [App\Http\Controllers\StaticProxyController::class, 'paymentIcon'])
