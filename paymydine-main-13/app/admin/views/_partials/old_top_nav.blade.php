        ...
        <div class="container-fluid">
            ...
            <script>
                document.addEventListener("DOMContentLoaded", function () {
                    function setImagePath(imgSelector, logoSelector, storageKey) {
                        let imgElement = document.querySelector(imgSelector);
                        let logoElement = document.querySelector(logoSelector);
                    ...
                    setImagePath("#mediafinder-formdashboardlogo-dashboard-logo img", "a.logo img", "dashboard_logo");
                    setImagePath("#mediafinder-formloaderlogo-loader-logo img", ".progress-indicator img", "loader_logo");
                    if (localStorage.getItem("dashboard_logo")) {
                        let logoElement = document.querySelector("a.logo img");
                        if (logoElement) logoElement.setAttribute("src", localStorage.getItem("dashboard_logo"));
                    }
                    if (localStorage.getItem("loader_logo")) {
                        let loaderLogoElement = document.querySelector(".progress-indicator img");
                        if (loaderLogoElement) loaderLogoElement.setAttribute("src", localStorage.getItem("loader_logo"));
                    }
                });
                document.addEventListener("DOMContentLoaded", function () {
                    if (localStorage.getItem("dashboard_logo")) {
